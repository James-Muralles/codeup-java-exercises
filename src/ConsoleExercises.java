...
// TODO: 3/20/20 Prompt a user to enter a integer and store that value in an int variable using the nextInt method.What happens if you Input.java something that is not an integer?
        
        //        double pi = 3.14159;
//        System.out.printf("The value of pi is approximately %.2f%n", pi);
//
//        System.out.println("Enter an integer.");
//        int number = Input.java.nextInt();
...
//        String wordOne = Input.java.next();
//        String wordTwo = Input.java.next();
//        String wordThree = Input.java.next();
...
//
//        String sentence = Input.java.next();
//
...
//        l = Input.java.nextDouble();
//        w = Input.java.nextDouble();
//        h = Input.java.nextDouble();
//        Perimeter = 2*(l +w);
//        Area = l * w;
//        Volume = l * w * h;
//
...
//        int length= Integer.parseInt(Input.java.nextLine());
//
//        System.out.println("Please enter width");
//        int width= Integer.parseInt(Input.java.nextLine());
//
